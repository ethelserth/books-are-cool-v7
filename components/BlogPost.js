      ...
      <Link passHref href={`${BLOG.path}/${post.slug}`} scroll={false}>
        ...
        >
          <Image
            ...
            alt={`${post.title}`}
            src={post?.page_cover}
            className='w-full h-full object-cover es object-center absolute inset-0 test-0 scale-110 transition duration-200'
          />
          ...
          <div className='relative mt-auto'>
            ...
            <p className='font-light hidden md:block leading-8 text-gray-700 dark:text-gray-300'>{post.Author}</p>
